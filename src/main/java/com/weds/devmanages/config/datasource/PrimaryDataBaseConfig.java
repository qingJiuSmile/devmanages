 ...
 **/
@Configuration
// 前缀为primary.datasource1.druid的配置信息
...
public class PrimaryDataBaseConfig {
     ...
     * dao层的包路径
     */
    static final String PACKAGE = "com.weds.devmanages.mapper.datasource1";

    /**
     * mapper文件的相对路径
     */
    private static final String MAPPER_LOCATION = "classpath:mybatis/mapper/datasource1/*.xml";
